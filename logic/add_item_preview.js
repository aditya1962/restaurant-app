...
{
  document.getElementById("category_label").innerHTML = document.getElementById("category").value;
  document.getElementById("subcategory_label").innerHTML = document.getElementById("sub_category").value;
