    ...
    <div class="user-body">
      ...
      <div class="document-body">
          ...
          <form method="post" action="give-feedback.php">
            <textarea class="form-control" name="product" rows="8" style="width:70%;"
            placeholder="Enter Feedback"></textarea>
            <br/>
            <div class="feedback-submit">
              <input type="submit" class="btn btn-primary" name="product"
              value="Submit" />
            </div>
          </form>
          <br/><br/>
          ...
          <form method="post" action="give-feedback.php">
            ...
            <br/>
            <div class="feedback-submit">
              <input type="submit" class="btn btn-primary" name="service"
              value="Submit" />
            </div>
          </form>
      </div>
